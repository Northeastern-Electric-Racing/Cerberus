...
int main(void)
{
	...
	defaultTaskHandle = osThreadNew(StartDefaultTask, (void *)mpu,
...
static void MX_GPIO_Init(void)
{
	...
	HAL_GPIO_WritePin(GPIOC,
			  MCU_FAULT_Pin | EXPAND_RST0_Pin | EXPAND_RST1_Pin |
	...
	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, SPARE_GPIO_3_Pin | WATCHDOG_Pin,
			  GPIO_PIN_RESET);

	/*Configure GPIO pins : MCU_FAULT_Pin EXPAND_RST0_Pin EXPAND_RST1_Pin DEBUG_LED1_Pin
                           DEBUG_LED2_Pin */
	GPIO_InitStruct.Pin = MCU_FAULT_Pin | EXPAND_RST0_Pin |
			      EXPAND_RST1_Pin | DEBUG_LED1_Pin | DEBUG_LED2_Pin;
