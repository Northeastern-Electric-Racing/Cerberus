...
{
    can_msg_t msg
		= { .id = 0x00000110, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000210, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000310, .len = 4, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000410, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000510, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000610, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000710, .len = 1, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000810, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000910, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000A10, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000B10, .len = 2, .line = CAN_LINE_1, .data = { 0 } };
...
{
    can_msg_t msg
		= { .id = 0x00000C10, .len = 1, .line = CAN_LINE_1, .data = { 0 } };
