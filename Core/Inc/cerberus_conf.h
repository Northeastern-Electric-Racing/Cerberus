...
#define MAX_APPS1_VOLTS	    3.09 /* volts */
#define MIN_APPS1_VOLTS	    1.73 /* volts */
#define MAX_APPS2_VOLTS	    2.27 /* volts */
#define MIN_APPS2_VOLTS	    0.90 /* volts */
#define PEDAL_BRAKE_THRESH  0.19 /* percentage */
