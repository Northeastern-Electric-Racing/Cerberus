...
typedef enum {
	...
	CAN_QUEUING_FAULT		 = 0x800,
	DTI_LIMITS_FAULT		 = 0x1000,
	DTI_CRITCAL_FAULT		 = 0x2000,
	ADC_INIT_FAULT			 = 0x4000,
	READ_ADC_FAULT			 = 0x8000,
	TEMP_READ_FAULT			 = 0x10000,
	ACCEL_READ_FAULT		 = 0x20000,
	GYRO_READ_FAULT			 = 0x40000,
	BMS_CAN_MONITOR_FAULT    = 0x80000,
	BUTTONS_MONITOR_FAULT    = 0xF0000,
	MAX_FAULTS
} fault_code_t;
