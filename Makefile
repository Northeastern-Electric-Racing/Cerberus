##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.2.0-B44] date: [Sun Jan 07 19:42:51 EST 2024] 
##########################################################################################################################
...
all: cangen $(BUILD_DIR)/$(TARGET).elf $(BUILD_DIR)/$(TARGET).hex $(BUILD_DIR)/$(TARGET).bin

cangen:
	python3 ./cerberusgen.py
