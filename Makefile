##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.2.0-B44] date: [Fri Apr 26 01:59:51 EDT 2024] 
##########################################################################################################################
...
all: format $(BUILD_DIR)/$(TARGET).elf $(BUILD_DIR)/$(TARGET).hex $(BUILD_DIR)/$(TARGET).bin
...
format:
	find Core/ -iname *.h -o -iname *.c | xargs clang-format --style=file -i
